...
<html lang="ko">
   	<head>
        <link rel="stylesheet" href="/resources/assets/css/V2Join.css">  
        ...
        <div class="container">
	        <div class="row d_flex ">
	            ...
	            <div class="col-md-6" style="margin-top: 70px;">
	               <form id="request" class="contrant align-items-center " method="post" name="frm">
                        <div class="row input-group">
                            ...
                            <div id="" role="main">
                                ...
                                <div id="content">
                        		<!-- tg-text=title -->
                                <h2 class="blind">오늘뭐먹조 회원가입</h2>
                                <div class="join_content">
                                    <div class="join_form">
                                        <form id="join_form" method="GET" action="/user2/V2Join?m=begin" >
                                            <input type="hidden" id="token_sjoin" name="token_sjoin" value="WvCobnNoeB0oD5F2">
                                            ...
                                            <div class="terms_p">
                                                <p class="terms_chk_all">
                                                    <span class="input_chk">
                                                        ...
                                                        <label for="chk_all"><span class="chk_all_txt">오늘뭐먹조 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택),<br class='m_br'> 프로모션 정보 수신(선택)에 모두 동의합니다.</span></label>
                                                    </span>
                                                </p>
                                                <ul class="terms_bx_list">
                                                    <li class="terms_bx">
                                                        <span class="input_chk">
                                                            ...
                                                            <label for="termsService">오늘뭐먹조 이용약관 동의<span class="terms_necessary">(필수)</span></label>
                                                        </span>
                                                        <div class="terms_box" tabindex="0" id="divService">
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <p class="article__text">
                                                                    오늘뭐먹조 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다.
                                                                    본 약관은 다양한 오늘뭐먹조 서비스의 이용과 관련하여 오늘뭐먹조 서비스를 제공하는 오늘뭐먹조 주식회사(이하 ‘오늘뭐먹조’)와
                                                                    이를 이용하는 오늘뭐먹조 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며,
                                                                    아울러 여러분의 오늘뭐먹조 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조 서비스를 이용하시거나 오늘뭐먹조 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로,
                                                                    잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">다양한 오늘뭐먹조 서비스를 즐겨보세요.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 <a href="https://www.naver.com/" target="_blank">www.naver.com</a>을 비롯한 오늘뭐먹조 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)을 통해 정보 검색,
                                                                    다른 이용자와의 커뮤니케이션, 콘텐츠 제공, 상품 쇼핑 등 여러분의 생활에 편리함을 더할 수 있는 다양한 서비스를 제공하고 있습니다.<br>
                                                                    여러분은 PC, 휴대폰 등 인터넷 이용이 가능한 각종 단말기를 통해 각양각색의 오늘뭐먹조 서비스를 자유롭게 이용하실 수 있으며,
                                                                    개별 서비스들의 구체적인 내용은 각 서비스 상의 안내, 공지사항, <a href="https://help.naver.com/support/home.nhn" target="_blank">오늘뭐먹조 웹고객센터(이하 ‘고객센터’)</a> 도움말 등에서 쉽게 확인하실 수 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 기본적으로 여러분 모두에게 동일한 내용의 서비스를 제공합니다.
                                                                ...
                                                                <p class="article__text">
                                                                    오늘뭐먹조 서비스에는 기본적으로 본 약관이 적용됩니다만 오늘뭐먹조가 다양한 서비스를 제공하는 과정에서 부득이 본 약관 외 별도의 약관, 운영정책 등을 적용하는 경우(예, 오늘뭐먹조페이, V LIVE 등)가 있습니다.
                                                                    그리고 오늘뭐먹조 계열사가 제공하는 특정 서비스의 경우에도(예, LINE, SNOW등) 해당 운영 회사가 정한 고유의 약관, 운영정책 등이 적용될 수 있습니다.
                                                                    이러한 내용은 각각의 해당 서비스 초기 화면에서 확인해 주시기 바랍니다.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">회원으로 가입하시면 오늘뭐먹조 서비스를 보다 편리하게 이용할 수 있습니다.</h3>
                                                                <p class="article__text">
                                                                    여러분은 본 약관을 읽고 동의하신 후 회원 가입을 신청하실 수 있으며,
                                                                    오늘뭐먹조는 이에 대한 승낙을 통해 회원 가입 절차를 완료하고 여러분께 오늘뭐먹조 서비스 이용 계정(이하 ‘계정’)을 부여합니다.
                                                                    계정이란 회원이 오늘뭐먹조 서비스에 로그인한 이후 이용하는 각종 서비스 이용 이력을 회원 별로 관리하기 위해 설정한 회원 식별 단위를 말합니다.
                                                                    회원은 자신의 계정을 통해 좀더 다양한 오늘뭐먹조 서비스를 보다 편리하게 이용할 수 있습니다.
                                                                    이와 관련한 상세한 내용은 <em>계정 운영정책</em> 및 고객센터 내 <a href="https://help.naver.com/support/contents/contents.nhn?serviceNo=532&categoryNo=1441" target="_blank">오늘뭐먹조 회원가입 방법</a> 등에서 확인해 주세요.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 단체에 속한 여러 구성원들이 공동의 계정으로 오늘뭐먹조 서비스를 함께 이용할 수 있도록 단체회원 계정도 부여하고 있습니다.
                                                                    ...
                                                                    멤버들의 단체회원 계정 로그인 방법 및 이를 통한 게시물 게재 등 오늘뭐먹조 서비스 이용을 관리(게시물 삭제 포함)할 수 있습니다.
                                                                ...
                                                                <p class="article__text">
                                                                    ...
                                                                    고객센터 내 <a href="https://help.naver.com/support/contents/contents.nhn?serviceNo=532&categoryNo=16952" target="_blank">오늘뭐먹조 단체회원(단체 아이디) 소개</a> 등에서 확인해 주시기 바랍니다.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">여러분이 제공한 콘텐츠를 소중히 다룰 것입니다.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 게재한 게시물이 오늘뭐먹조 서비스를 통해 다른 이용자들에게 전달되어 우리 모두의 삶을 더욱 풍요롭게 해줄 것을 기대합니다.
                                                                    게시물은 여러분이 타인 또는 자신이 보게 할 목적으로 오늘뭐먹조 서비스 상에 게재한 부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로
                                                                    구성된 각종 콘텐츠 자체 또는 파일을 말합니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분의 생각과 감정이 표현된 콘텐츠를 소중히 보호할 것을 약속 드립니다.
                                                                    여러분이 제작하여 게재한 게시물에 대한 지식재산권 등의 권리는 당연히 여러분에게 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    한편, 오늘뭐먹조 서비스를 통해 여러분이 게재한 게시물을 적법하게 제공하려면 해당 콘텐츠에 대한 저장, 복제, 수정, 공중 송신, 전시, 배포,
                                                                    2차적 저작물 작성(단, 번역에 한함) 등의 이용 권한(기한과 지역 제한에 정함이 없으며, 별도 대가 지급이 없는 라이선스)이 필요합니다.<br>
                                                                    게시물 게재로 여러분은 오늘뭐먹조에게 그러한 권한을 부여하게 되므로, 여러분은 이에 필요한 권리를 보유하고 있어야 합니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 부여해 주신 콘텐츠 이용 권한을 저작권법 등 관련 법령에서 정하는 바에 따라 오늘뭐먹조 서비스 내 노출, 서비스 홍보를 위한 활용,
                                                                ...
                                                                <p class="article__text">
                                                                    또한 여러분이 제공한 소중한 콘텐츠는 오늘뭐먹조 서비스를 개선하고 새로운 오늘뭐먹조 서비스를 제공하기 위해 인공지능 분야 기술 등의 연구 개발 목적으로 오늘뭐먹조 및 오늘뭐먹조 계열사에서 사용될 수 있습니다.
                                                                    오늘뭐먹조는 지속적인 연구 개발을 통해 여러분께 좀 더 편리하고 유용한 서비스를 제공해 드릴 수 있도록 최선을 다하겠습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 자신이 제공한 콘텐츠에 대한 오늘뭐먹조 또는 다른 이용자들의 이용 또는 접근을 보다 쉽게 관리할 수 있도록 다양한 수단을 제공하기 위해 노력하고 있습니다.
                                                                    여러분은 오늘뭐먹조 서비스 내에 콘텐츠 삭제, 비공개 등의 관리기능이 제공되는 경우 이를 통해 직접 타인의 이용 또는 접근을 통제할 수 있고,
                                                                    고객센터를 통해서도 콘텐츠의 삭제, 비공개, 검색결과 제외 등의 조치를 요청할 수 있습니다.<br>
                                                                    다만, 일부 오늘뭐먹조 서비스의 경우 삭제, 비공개 등의 처리가 어려울 수 있으며,
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 서비스의 원활한 제공을 위하여 회원이 동의한 목적과 범위 내에서만 개인정보를 수집∙이용하며, 개인정보 보호 관련 법령에 따라 안전하게 관리합니다.
                                                                    오늘뭐먹조가 이용자 및 회원에 대해 관련 개인정보를 안전하게 처리하기 위하여 기울이는 노력이나
                                                                    기타 상세한 사항은 <a href="http://policy.naver.com/policy/privacy.html" target="_blank">개인정보 처리방침</a>에서 확인하실 수 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 서비스를 이용하기 위해 일정 기간 동안 로그인 혹은 접속한 기록이 없는 경우, 전자메일, 서비스 내 알림 또는 기타 적절한 전자적 수단을 통해 사전에 안내해 드린 후 여러분의 정보를 파기하거나 분리 보관할 수 있으며,
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <p class="article__text">
                                                                    ...
                                                                    오늘뭐먹조는 이에 대한 문제 해결을 위해 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’ 및 ‘저작권법’ 등을
                                                                ...
                                                                <p class="article__text">
                                                                    한편, 오늘뭐먹조 서비스를 통해 타인의 콘텐츠를 이용한다고 하여 여러분이 해당 콘텐츠에 대한 지식재산권을 보유하게 되는 것은 아닙니다.
                                                                    여러분이 해당 콘텐츠를 자유롭게 이용하기 위해서는 그 이용이 저작권법 등 관련 법률에 따라 허용되는 범위 내에 있거나,
                                                                    해당 콘텐츠의 지식재산권자로부터 별도의 이용 허락을 받아야 하므로 각별한 주의가 필요합니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 오늘뭐먹조 서비스를 마음껏 이용할 수 있도록 여러분께 오늘뭐먹조 서비스에 수반되는 관련 소프트웨어 사용에 관한 이용 권한을 부여합니다.
                                                                    이 경우 여러분의 자유로운 이용은 오늘뭐먹조가 제시하는 이용 조건에 부합하는 범위 내에서만 허용되고, 이러한 권한은 양도가 불가능하며,
                                                                    비독점적 조건 및 <a href="http://policy.naver.com/policy/disclaimer.html" target="_blank">법적고지</a>가 적용된다는 점을 유의해 주세요.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">오늘뭐먹조에서 제공하는 다양한 포인트를 요긴하게 활용해 보세요.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 오늘뭐먹조 서비스를 효율적으로 이용할 수 있도록 포인트를 부여하고 있습니다.
                                                                    포인트는 여러분의 일정한 오늘뭐먹조 서비스 이용과 연동하여 오늘뭐먹조가 임의로 책정하거나 조정하여 지급하는 일정한 계산 단위를 갖는 서비스 상의
                                                                    가상 데이터를 말합니다. 포인트는 재산적 가치가 없기 때문에 금전으로 환불 또는 전환할 수 없지만,
                                                                    포인트의 많고 적음에 따라 여러분의 오늘뭐먹조 서비스 이용에 영향을 주는 경우가 있으므로 경우에 따라 적절히 활용해 보세요.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 오늘뭐먹조 서비스의 효율적 이용을 지원하거나 서비스 운영을 개선하기 위해 필요한 경우 사전에 여러분께 안내 드린 후
                                                                    부득이 포인트의 일부 또는 전부를 조정할 수 있습니다.
                                                                    그리고 포인트는 오늘뭐먹조가 정한 기간에 따라 주기적으로 소멸할 수도 있으니 포인트가 부여되는 오늘뭐먹조 서비스 이용 시 유의해 주시기 바랍니다.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">오늘뭐먹조 서비스 이용과 관련하여 몇 가지 주의사항이 있습니다.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 오늘뭐먹조 서비스를 자유롭고 편리하게 이용할 수 있도록 최선을 다하고 있습니다.
                                                                    다만, 여러분이 오늘뭐먹조 서비스를 보다 안전하게 이용하고 오늘뭐먹조 서비스에서 여러분과 타인의 권리가 서로 존중되고 보호받으려면
                                                                    여러분의 도움과 협조가 필요합니다. 여러분의 안전한 서비스 이용과 권리 보호를 위해 부득이 아래와 같은 경우
                                                                    여러분의 게시물 게재나 오늘뭐먹조 서비스 이용이 제한될 수 있으므로, 이에 대한 확인 및 준수를 요청 드립니다.
                                                                </p>
                                                                <ul class="article__text">
                                                                    ...
                                                                    <li class="article__text__list">
                                                                        자동화된 수단을 활용하는 등 오늘뭐먹조 서비스의 기능을 비정상적으로 이용하여 게재된 게시물, 오늘뭐먹조 각 개별 서비스의 제공 취지와
                                                                        부합하지 않는 내용의 게시물은 다른 이용자들의 정상적인 오늘뭐먹조 서비스 이용에 불편을 초래하고 더 나아가 오늘뭐먹조의 원활한 서비스 제공을 방해하므로 역시 제한될 수 있습니다.
                                                                        기타 제한되는 게시물에 관한 상세한 내용은 <em>게시물 운영정책</em> 및 각 개별 서비스에서의 약관, 운영정책 등을 참고해 주시기 바랍니다.
                                                                    </li>
                                                                    <li class="article__text__list">
                                                                        <span class="article__text">오늘뭐먹조의 사전 허락 없이 자동화된 수단(예: 매크로 프로그램, 로봇(봇), 스파이더, 스크래퍼 등)을 이용하여 오늘뭐먹조 서비스 회원으로 가입을 시도 또는 가입하거나,
                                                                        오늘뭐먹조 서비스에 로그인을 시도 또는 로그인하거나, 오늘뭐먹조 서비스 상에 게시물을 게재하거나, 오늘뭐먹조 서비스를 통해 커뮤니케이션하거나(예: 전자메일, 쪽지 등),</span>
                                                                        오늘뭐먹조 서비스에 게재된 회원의 아이디(ID), 게시물 등을 수집하거나, 오늘뭐먹조 검색 서비스에서 특정 질의어로 검색하거나
                                                                        혹은 그 검색결과에서 특정 검색결과를 선택(이른바 ‘클릭’)하는 등 <span class="article__text">이용자(사람)의 실제 이용을 전제로 하는 오늘뭐먹조 서비스의 제공 취지에 부합하지 않는 방식으로
                                                                        오늘뭐먹조 서비스를 이용하거나 이와 같은 오늘뭐먹조 서비스에 대한 어뷰징(남용) 행위를 막기 위한 오늘뭐먹조의 기술적 조치를 무력화하려는 일체의 행위</span>(예: IP를 지속적으로 바꿔가며 접속하는 행위,
                                                                        Captcha를 외부 솔루션 등을 통해 우회하거나 무력화 하는 행위 등)를 시도해서는 안 됩니다.
                                                                    </li>
                                                                    <li class="article__text__list">
                                                                        <span class="article__text">오늘뭐먹조의 동의 없이 자동화된 수단에 의해 오늘뭐먹조 서비스 상에 광고가 게재되는 영역 또는 그 밖의 영역에 부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로
                                                                        구성된 각종 콘텐츠 자체 또는 파일을 삽입</span>해서는 안 됩니다. 또한, 오늘뭐먹조 서비스 또는 이에 포함된 소프트웨어를 복사, 수정할 수 없으며,
                                                                        이를 판매, 양도, 대여 또는 담보로 제공하거나 타인에게 그 이용을 허락해서는 안 됩니다. 오늘뭐먹조 서비스에 포함된 소프트웨어를 역 설계, 소스코드 추출 시도,
                                                                        복제, 분해, 모방, 기타 변형하는 등의 행위도 금지됩니다(다만, 오픈소스에 해당되는 경우 그 자체 조건에 따릅니다).
                                                                        <span class="article__text">그 밖에 바이러스나 기타 악성 코드를 업로드하거나 오늘뭐먹조 서비스의 원활한 운영을 방해할 목적으로 서비스 기능을 비정상적으로 이용하는 행위</span> 역시 금지됩니다.
                                                                    </li>
                                                                </ul>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 본 약관의 범위 내에서 게시물 운영정책, 각 개별 서비스에서의 약관 또는 운영정책, 각 서비스 상의 안내, 공지사항, 고객센터 도움말 등을 두어,
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 다양한 정보와 의견이 담긴 여러분의 콘텐츠를 소중히 다룰 것을 약속 드립니다만, 여러분이 게재한 게시물이 관련 법령, 본 약관, 게시물 운영정책,
                                                                    각 개별 서비스에서의 약관, 운영정책 등에 위배되는 경우, 부득이 이를 비공개 또는 삭제 처리하거나 게재를 거부할 수 있습니다.
                                                                    다만, 이것이 오늘뭐먹조가 모든 콘텐츠를 검토할 의무가 있다는 것을 의미하지는 않습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    또한 여러분이 관련 법령, 본 약관, 계정 및 게시물 운영정책, 각 개별 서비스에서의 약관, 운영정책 등을 준수하지 않을 경우,
                                                                    오늘뭐먹조는 여러분의 관련 행위 내용을 확인할 수 있으며, 그 확인 결과에 따라 오늘뭐먹조 서비스 이용에 대한 주의를 당부하거나,
                                                                    오늘뭐먹조 서비스 이용을 일부 또는 전부, 일시 또는 영구히 정지시키는 등 그 이용을 제한할 수 있습니다.
                                                                    한편, 이러한 이용 제한에도 불구하고 더 이상 오늘뭐먹조 서비스 이용계약의 온전한 유지를 기대하기 어려운 경우엔 부득이 여러분과의 이용계약을 해지할 수 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                            ...
                                                            <div class="article">
                                                                <h3 class="article__title">오늘뭐먹조의 잘못은 오늘뭐먹조가 책임집니다.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분이 오늘뭐먹조 서비스를 이용함에 있어 오늘뭐먹조의 고의 또는 과실로 인하여 손해를 입게 될 경우 관련 법령에 따라 여러분의 손해를 배상합니다.
                                                                    다만, 천재지변 또는 이에 준하는 불가항력으로 인하여 오늘뭐먹조가 서비스를 제공할 수 없거나 이용자의 고의 또는 과실로 인하여 서비스를 이용할 수 없어
                                                                    발생한 손해에 대해서 오늘뭐먹조는 책임을 부담하지 않습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    그리고 오늘뭐먹조가 손해배상책임을 부담하는 경우에도 통상적으로 예견이 불가능하거나 특별한 사정으로 인한 특별 손해 또는 간접 손해,
                                                                    기타 징벌적 손해에 대해서는 관련 법령에 특별한 규정이 없는 한 책임을 부담하지 않습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    한편, 오늘뭐먹조 서비스를 매개로 한 여러분과 다른 회원 간 또는 여러분과 비회원 간의 의견 교환,
                                                                    거래 등에서 발생한 손해나 여러분이 서비스 상에 게재된 타인의 게시물 등의 콘텐츠를 신뢰함으로써 발생한 손해에 대해서도
                                                                    오늘뭐먹조는 특별한 사정이 없는 한 이에 대해 책임을 부담하지 않습니다.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">언제든지 오늘뭐먹조 서비스 이용계약을 해지하실 수 있습니다.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조에게는 참 안타까운 일입니다만, 회원은 언제든지 오늘뭐먹조 서비스 이용계약 해지를 신청하여 회원에서 탈퇴할 수 있으며,
                                                                    이 경우 오늘뭐먹조는 관련 법령 등이 정하는 바에 따라 이를 지체 없이 처리하겠습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조 서비스 이용계약이 해지되면, 관련 법령 및 개인정보처리방침에 따라 오늘뭐먹조가 해당 회원의 정보를 보유할 수 있는 경우를 제외하고,
                                                            ...
                                                            <div class="article">
                                                                <h3 class="article__title">일부 오늘뭐먹조 서비스에는 광고가 포함되어 있습니다.</h3>
                                                                <p class="article__text">
                                                                    여러분이 다양한 오늘뭐먹조 서비스를 이용하다 보면 간혹 일부 개별 서비스에 광고가 포함된 경우가 있습니다.
                                                                    오늘뭐먹조 서비스를 이용하면서 발생할 수 있는 데이터 통신요금은 가입하신 통신사업자와의 이용계약에 따라 여러분이 부담하며,
                                                                    포함된 광고 열람으로 인해 추가적으로 발생하는 비용 역시 여러분이 부담합니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    <span class="article__text">원하는 오늘뭐먹조 서비스를 이용하기 위해 원하지 않는 광고를 봐야 하는 경우가 있습니다.
                                                                    이는 여러분에게 제공하는 다양한 오늘뭐먹조 서비스를 원칙적으로 무료로 제공할 수 있게 해주는 데 기여하며,
                                                                    더 나아가 오늘뭐먹조가 연구 개발에 투자하여 더 나은 서비스를 제공할 수 있는 기반이 됩니다.
                                                                    최근 타사의 일부 서비스들이 광고 없는 서비스 이용을 강조하며 주된 서비스를 유료로 제공하고 있는 관행이 이를 뒷받침합니다.
                                                                    </span>
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분의 본의 아닌 불편이나 부담이 최소화될 수 있는 방법에 대해 항상 고민하고 개선해 나가겠습니다.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">서비스 중단 또는 변경 시 꼭 알려드리겠습니다.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 연중 무휴, 1일 24시간 안정적으로 서비스를 제공하기 위해 최선을 다하고 있습니다만, 컴퓨터, 서버 등 정보통신설비의 보수점검,
                                                                    교체 또는 고장, 통신두절 등 운영상 상당한 이유가 있는 경우 부득이 서비스의 전부 또는 일부를 중단할 수 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    한편, 오늘뭐먹조는 서비스 운영 또는 개선을 위해 상당한 필요성이 있는 경우 서비스의 전부 또는 일부를 수정, 변경 또는 종료할 수 있습니다.
                                                                    무료로 제공되는 서비스의 전부 또는 일부를 수정, 변경 또는 종료하게 된 경우 관련 법령에 특별한 규정이 없는 한 별도의 보상을 하지 않습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    이 경우 오늘뭐먹조는 예측 가능한 경우 상당기간 전에 이를 안내하며, 만약 예측 불가능한 경우라면 사후 지체 없이 상세히 설명하고 안내 드리겠습니다.
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 서비스 이용에 필요한 주요사항을 적시에 잘 안내해 드릴 수 있도록 힘쓰겠습니다.
                                                                    회원에게 통지를 하는 경우 전자메일, 서비스 내 알림 또는 기타 적절한 전자적 수단을 통해 개별적으로 알려 드릴 것이며,
                                                                    다만 회원 전체에 대한 통지가 필요할 경우엔 7일 이상 <a href="https://www.naver.com" target="_blank">www.naver.com</a>을 비롯한 오늘뭐먹조 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)
                                                                    초기 화면 또는 공지사항 등에 관련 내용을 게시하도록 하겠습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 여러분의 소중한 의견에 귀 기울이겠습니다. 여러분은 언제든지 고객센터를 통해 서비스 이용과 관련된 의견이나 개선사항을 전달할 수 있으며,
                                                                    오늘뭐먹조는 합리적 범위 내에서 가능한 그 처리과정 및 결과를 여러분께 전달할 수 있도록 하겠습니다.
                                                                </p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">여러분이 쉽게 알 수 있도록 약관 및 운영정책을 게시하며 사전 공지 후 개정합니다.</h3>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 본 약관의 내용을 여러분이 쉽게 확인할 수 있도록 서비스 초기 화면에 게시하고 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 수시로 본 약관, 계정 및 게시물 운영정책을 개정할 수 있습니다만, 관련 법령을 위배하지 않는 범위 내에서 개정할 것이며,
                                                                ...
                                                                <p class="article__text">
                                                                    오늘뭐먹조는 변경된 약관을 게시한 날로부터 효력이 발생되는 날까지 약관 변경에 대한 여러분의 의견을 기다립니다.
                                                                    위 기간이 지나도록 여러분의 의견이 오늘뭐먹조에 접수되지 않으면, 여러분이 변경된 약관에 따라 서비스를 이용하는 데에 동의하는 것으로 간주됩니다.
                                                                    오늘뭐먹조로서는 매우 안타까운 일이지만, 여러분이 변경된 약관에 동의하지 않는 경우 변경된 약관의 적용을 받는 해당 서비스의 제공이 더 이상 불가능하게 될 수 있습니다.
                                                                </p>
                                                                <p class="article__text">
                                                                    오늘뭐먹조 서비스에는 기본적으로 본 약관이 적용됩니다만, 부득이 각 개별 서비스의 고유한 특성을 반영하기 위해 본 약관 외 별도의 약관,
                                                                ...
                                                                <p class="article__text">
                                                                    본 약관은 한국어를 정본으로 합니다. 본 약관 또는 오늘뭐먹조 서비스와 관련된 여러분과 오늘뭐먹조와의 관계에는 대한민국의 법령이 적용됩니다.
                                                                    그리고 본 약관 또는 오늘뭐먹조 서비스와 관련하여 여러분과 오늘뭐먹조 사이에 분쟁이 발생할 경우,
                                                                ...
                                                                <p class="article__text">
                                                                    오늘뭐먹조 서비스와 관련하여 궁금하신 사항이 있으시면 <a href="https://help.naver.com/" target="_blank">고객센터</a>(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
                                                                </p>
                                                            </div>                                
                                                        </div>
                                                    </li>
                                                    <li class="terms_bx">
                                                        ...
                                                        <div class="terms_box" tabindex="0" id="divPrivacy">
                                                            ...
                                                            <div class="policy_summary">
                                                                <p class="policy_summary__text">개인정보보호법에 따라 오늘뭐먹조에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">1. 수집하는 개인정보</h3>
                                                                <p class="article__text">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 오늘뭐먹조 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 오늘뭐먹조는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
                                                                <div class="clause">
                                                                    <h4 class="clause__title">회원가입 시점에 오늘뭐먹조가 이용자로부터 수집하는 개인정보는 아래와 같습니다.</h4>
                                                                    <ul class="sections">
                                                                    ...
                                                                    <p class="clause__text">- 오늘뭐먹조 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.</p>
                                                                    ...
                                                                    <p class="clause__text">
                                                                        ...
                                                                        오늘뭐먹조에서 제공하는 위치기반 서비스에 대해서는 '오늘뭐먹조 위치정보 이용약관'에서 자세하게 규정하고 있습니다.<br>
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <p class="article__text">오늘뭐먹조 및 오늘뭐먹조 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.</p>
                                                                <ul class="sections">
                                                                    ...
                                                                    <li class="sections__section">- 법령 및 오늘뭐먹조 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.</li>
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <div class="clause">
                                                                    ...
                                                                    <ul class="sections">
                                                                        ...
                                                                        <li class="sections__section">- 오늘뭐먹조 플러스 멤버십 서비스 혜택 중복 제공 방지
                                                                ...
                                                                <div class="clause">
                                                                    <h4 class="clause__title">
                                                                        ...
                                                                        오늘뭐먹조는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.
                                                                    </h4>
                                                                    <ul class="sections">
                                                                    ...
                                                                    <p class="clause__text"><p class="clause__text">
                                                                        참고로 오늘뭐먹조는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="article">
                                                    ...
                                                    <li class="terms_bx">
                                                        ...
                                                        <div class="terms_box" id="divLocation">
                                                                    <!-- 위치정보 이용약관 동의 -->
                                                            <div class="policy_summary">
                                                                <p class="policy_summary__text">위치정보 이용약관에 동의하시면, <strong>위치를 활용한 광고 정보 수신</strong> 등을 포함하는 오늘뭐먹조 위치기반 서비스를 이용할 수 있습니다.</p><br>
                                                            </div>
                                                            <div class="article">
                                                                <h3 class="article__title">제 1 조 (목적)</h3>
                                                                <p class="article__text">이 약관은 오늘뭐먹조 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                                                            </div>
                                                            <div class="article">
                                                            ...
                                                            <div class="article">
                                                                ...
                                                                <ul class="sections">
                                                                    <li class="sections__section">상호: 오늘뭐먹조 주식회사</li>
                                                                    <li class="sections__section">주소: 서울특별시 양천구 목동남로2길 60-30 (08105) </li>
                                                                    <li class="sections__section">전화번호: 010-7165-1244</li>
                                                                    <li class="sections__section">이메일 주소: ksj000414@naver.com</li>
                                                                </ul>
                                                            </div>
                                                            <div class="article">
                                                ...
                                                <span class="event_message" style="display:block">오늘뭐먹조에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(오늘뭐먹조앱 알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도 회원 체계로 운영하거나 오늘뭐먹조 가입 이후 추가 가입하여 이용하는 서비스 등)의 경우, 개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로 안내하고 동의를 받습니다.</span>
                                                <span class="error" id="agreeMsg" style="display:none">오늘뭐먹조 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.</span>
                                            </div>
                                            <!-- //약관동의 -->
                                            <a name='agreeBottom'></a>
                                            <div class="btn_area double">
                                                <span><!-- tg-text=terms_button_agree --><a href="/member/managerJoin" id="btnAgree" class="btn_type btn_primary" role="button">사장님 회원가입</a></span>
                                                <span><!-- tg-text=terms_button_cancel --><a href="/member/memberJoin" id="btnCancel" class="btn_type btn_default" role="button">사용자 회원가입</a></span>
                                            </div>
                                        </form>
                                    </div>
                                </div>
