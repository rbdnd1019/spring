	            ...
	            <div class="col-md-6" style="margin-top: 70px;">
	               <form id="request" class="main_form align-items-center " method="post" name="frm">
	                  <div class="row input-group">
	                     ...
	                     <div class="col-md-12 ">
							<label for="owner">대표자 이름</label>
	                        <input class="contactus mb-5" placeholder="대표자 이름" type="text" name="bossName">
	                     </div>
	                     <div class="col-md-12 ">
							<label for="owner">사업자번호</label>
	                        <input class="contactus mb-5" placeholder="사업자번호" type="text" name="bno">
	                     </div>
